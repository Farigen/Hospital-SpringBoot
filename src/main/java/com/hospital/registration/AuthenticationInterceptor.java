...
import com.hospital.registration.annotation.PassToken;
...
//                User user = userService.findUserById(userId);
                //待修改，此处patient没有password
                Patient patient = patientService.getPatientInfoByPhoneNumber(userId);
                if (patient == null) {
